<template>
    <Link :href="href" class="w-full xl:w-1/2">
        <div class="flex flex-col h-full bg-grey-5 dark:bg-gray-800 p-4 border-2 border-transparent hover:border-blue
            ...
            <div class="flex flex-row items-center flex-initial" v-if="progressBarId !== null">
