<template>
    ...
    <div class="flex items-center justify-center w-screen h-full bg-gray-100 dark:bg-gray-800 p-4">
        <div class="flex flex-col items-center w-full max-w-md bg-white dark:bg-black shadow-md px-8 sm:px-16 py-8">
            ...
            <p class="mb-8 text-center">Thank you for verifying your email. Please enter your new password below. Once your password has been reset, you will be redirected to the sign in page.</p>
            <form @submit.prevent="submit" class="flex flex-col w-full">
                ...
                <Input id="password_confirmation" class="w-full" label="Password Confirmation" type="password" v-model="form.password_confirmation"
                       required autocomplete="new-password"/>
