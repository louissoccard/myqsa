<template>
    ...
    <Page>
        <form @submit.prevent="submit" class="flex flex-col w-full">
            <Input id="email-address" class="mb-6 w-full" label="Email Address" type="email" v-model="form.email"
                   required autofocus/>
        ...
        <div class="my-6 py-4 w-full border-y border-gray-400 dark:border-gray-700 text-center">
            <div class="cursor-pointer">
                ...
                <svg class="inline dark:hidden" xmlns="http://www.w3.org/2000/svg" width="215" height="41"
                     viewBox="0 0 215 41"><title>MS-SymbolLockup</title>
            ...
            <p class="mt-2 text-sm">Use your Hampshire Scouts account</p>
        </div>
        <p>Need a myQSA account?
            <Link :href="route('register')" class="font-bold hover:text-blue">Register</Link>
        </p>
    </Page>
</template>
...
export default defineComponent({
    components: {Page, Button, Input, ValidationErrors, Head, Link, Message},
    layout: null,
